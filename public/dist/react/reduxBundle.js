...
var _reg = __webpack_require__(324);
...
var _emp = __webpack_require__(320);

var _emp2 = _interopRequireDefault(_emp);

var _getEmp = __webpack_require__(321);

var _getEmp2 = _interopRequireDefault(_getEmp);

var _addEmp = __webpack_require__(319);
...
//实例导航
var ReduxNav = function (_React$Component) {
    _inherits(ReduxNav, _React$Component);

    function ReduxNav(props) {
        _classCallCheck(this, ReduxNav);

        return _possibleConstructorReturn(this, (ReduxNav.__proto__ || Object.getPrototypeOf(ReduxNav)).call(this, props));
    }

    _createClass(ReduxNav, [{
        key: "render",
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            "span",
                            null,
                            "--(\u5728\u6CE8\u518C(reg.js)\u548C\u5458\u5DE5\u5217\u8868(getEmp.js)\u4E2D\u4F7F\u7528\u4E86redux)"
                        )
                    )
                ),
                this.props.children
...
var store = (0, _redux.createStore)(_reducer2.default, (0, _redux.applyMiddleware)(_reduxThunk2.default, logger));
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baseGetTag_js__ = __webpack_require__(282);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__getPrototype_js__ = __webpack_require__(284);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__isObjectLike_js__ = __webpack_require__(289);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_PropTypes__ = __webpack_require__(272);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_verifyPlainObject__ = __webpack_require__(273);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__getRawTag_js__ = __webpack_require__(285);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__objectToString_js__ = __webpack_require__(286);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(267)))
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__overArg_js__ = __webpack_require__(287);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__freeGlobal_js__ = __webpack_require__(283);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_PropTypes__ = __webpack_require__(272);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_warning__ = __webpack_require__(266);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__verifySubselectors__ = __webpack_require__(296);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_warning__ = __webpack_require__(266);
/* unused harmony export default */
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(267), __webpack_require__(308)(module)))
...
var _Node_list = __webpack_require__(313);
...
var ALL = _actions.filter.ALL,
    COMPLETED = _actions.filter.COMPLETED,
    ACTIVE = _actions.filter.ACTIVE;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_AddTodo2.default, {
                    addTodo: function addTodo(inputMemo) {
                        dispatch((0, _actions.thunk_addTodo)(index, inputMemo));
                    }
                }),
                _react2.default.createElement(_Node_list2.default, {
                    listData: listData,
                    switchMemo: function switchMemo(item) {
                        dispatch((0, _actions.completedTodo)(item.id));
                    }
                }),
                _react2.default.createElement(_Filter2.default, {
                    showType: showType,
                    setShowType: function setShowType(choseType) {
                        dispatch((0, _actions.setShowType)(choseType));
                    }
                })
            );
        }
...
function filterFn(state) {
    switch (state.showType) {
        ...
        case COMPLETED:
            return state.listData.filter(function (item) {
                return item.done;
            });
        case ACTIVE:
            return state.listData.filter(function (item) {
...
exports.default = (0, _reactRedux.connect)(select)(todoList);
...
exports.filter = exports.INCREMENT_ID = exports.SET_SHOW_TYPE = exports.COMPLETED_TODO = exports.ADD_TODO = undefined;
exports.addTodo = addTodo;
exports.completedTodo = completedTodo;
exports.setShowType = setShowType;
exports.incrementID = incrementID;
exports.thunk_addTodo = thunk_addTodo;
exports.usernameIsUse = usernameIsUse;
exports.asynNameisUse = asynNameisUse;
exports.regIsSuccess = regIsSuccess;
exports.asynReg = asynReg;
exports.getEmpByPage = getEmpByPage;
exports.asynGetEmpByPage = asynGetEmpByPage;
exports.asynDelById = asynDelById;
exports.setCurPage = setCurPage;
...
var SET_SHOW_TYPE = exports.SET_SHOW_TYPE = "SET_SHOW_TYPE";
var INCREMENT_ID = exports.INCREMENT_ID = "INCREMENT_ID";
...
function thunk_addTodo(id, content) {
...
//--------------------------EMP action-----------------------------
function usernameIsUse(isUse) {
    return {
        type: "usernameIsUse",
        isUse: isUse
    };
}
function asynNameisUse(username) {
    return function (dispatch) {
...
function regIsSuccess(isSuccess) {
    return {
        type: "regIsSuccess",
        isSuccess: isSuccess
    };
}
function asynReg(username, password) {
    return function (dispatch) {
...
//员工列表
function getEmpByPage(empData) {
    return {
        type: "getEmpByPage",
        empData: empData
    };
}
function asynGetEmpByPage() {
    var curPage = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
    var eachPage = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 10;
...
function showType() {
	var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _actions.filter.ALL;
	var action = arguments[1];

	switch (action.type) {
		case _actions.SET_SHOW_TYPE:
...
function empData() {
	var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : testEmpData;
	var action = arguments[1];
...
var GetEmp = function (_React$Component) {
    ...
    function GetEmp(props) {
        ...
        return _possibleConstructorReturn(this, (GetEmp.__proto__ || Object.getPrototypeOf(GetEmp)).call(this, props));
    }
    ...
    _createClass(GetEmp, [{
        ...
        value: function componentWillMount() {
            this.props.dispatch((0, _actions.asynGetEmpByPage)(1, 10));
        }
    }, {
        key: "render",
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_list2.default, { delFn: function delFn(_id) {
                        dispatch((0, _actions.asynDelById)(_id));
                    }, listData: empData.listData }),
                _react2.default.createElement(_pagination2.default, _extends({
                    setCurPage: function setCurPage(curPage) {
                        dispatch((0, _actions.setCurPage)(curPage));
                    }
                }, empData))
            );
        }
...
exports.default = (0, _reactRedux.connect)(select)(GetEmp);
...
var Reg = function (_React$Component) {
    ...
    _createClass(Reg, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                dispatch = _props.dispatch,
                usernameIsUse = _props.usernameIsUse,
                regIsSuccess = _props.regIsSuccess;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement("input", { type: "text", ref: "username", placeholder: "\u8BF7\u8F93\u5165\u8D26\u6237\u68C0\u6D4B\u662F\u5426\u88AB\u4F7F\u7528", onBlur: function onBlur() {
                            dispatch((0, _actions.asynNameisUse)(_this2.refs.username.value));
                        } }),
                    usernameIsUse ? "该用户名已被使用" : ""
                ),
                _react2.default.createElement(
                    "div",
                    null,
                ...
                _react2.default.createElement(
                    ...
                    " ",
                    _react2.default.createElement("input", { type: "button", value: "\u6CE8\u518C", onClick: function onClick() {
                            dispatch((0, _actions.asynReg)(_this2.refs.username.value, _this2.refs.password.value));
                        }, disabled: usernameIsUse })
                )
            );
        }
    }, {
...
exports.default = (0, _reactRedux.connect)(select)(Reg);
...
//# sourceMappingURL=reduxBundle.js.map